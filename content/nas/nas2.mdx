export const lastUpdated = '10 Nov 2022'
...
Although spinning the disks up and down repeatedly causes more wear and tear than keeping them spinning,
...
APM levels above 128 do not allow drives to spin down.
...
It looks like `hdparm` settings are not persistent after reboot.
...
Prometheus provides some basic visualisation but it's nothing compared to what
Grafana can do.
