export const lastUpdated = '31 Oct 2022'
...
Alternatively, run this command after startup if GUI is not needed.
...
<Callout>
Setting maximum number of players exactly as the actual number of players
seems to block players retrying connection after entering a wrong password.
</Callout>
